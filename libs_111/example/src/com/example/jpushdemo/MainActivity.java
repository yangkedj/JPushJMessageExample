...
public class MainActivity extends Activity implements OnClickListener{
	...
	private void initView(){
		...
		mIm_test = (Button)findViewById(R.id.im_test);
		mIm_test.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.setting:
			...
			break;
		case R.id.im_test:
			Intent intentImTest = new Intent(MainActivity.this, IMMainActivity.class);
			startActivity(intentImTest);
			break;
		case R.id.stopPush:
