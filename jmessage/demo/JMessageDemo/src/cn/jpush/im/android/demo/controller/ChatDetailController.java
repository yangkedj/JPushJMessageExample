...
public class ChatDetailController implements OnClickListener,
    ...
    private void initData() {
        ...
        if (mIsGroup) {
            ...
            String myNickName = JMessageClient.getCurrentUser().getNickname();
            // TODO 群名，昵称，群人数等初始化
...
//                }
    ...
    public void onItemClick(AdapterView<?> viewAdapter, View view,
        ...
        if (!mIsShowDelete) {
            ...
            if (position < mCurrentNum) {
                ...
                if(mMemberIDList.get(position).equals(JMessageClient.getCurrentUser().getUserName())){
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case 0:
                    ...
                    // 判断是否为群主
                    if (mGroupOwnerID != null && mGroupOwnerID.equals(JMessageClient.getCurrentUser().getUserName()))
                        mIsCreator = true;
                    mChatDetailView.setMyName(JMessageClient.getCurrentUser().getUserName());
                ...
                case 1:
                    ...
                    if (mIsGroup)
                        ...
                        if (newMember.equals(JMessageClient.getCurrentUser().getUserName()) || newMember.equals(mTargetID))
                            return;
    ...
    private void addMemberAndCreateGroup(final String newMember) {
        ...
        final String desc = "";
        mLoadingDialog.show();
        final String groupName = JMessageClient.getCurrentUser().getUserName() + "、" + mTargetID
                + "、" + newMember;
