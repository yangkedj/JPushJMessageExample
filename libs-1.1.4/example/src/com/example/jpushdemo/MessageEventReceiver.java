...
//	测试自动回复功能
    ...
    public void onEvent(NotificationClickEvent event)
    {
    	...
    	Log.d("iMessage", "旧接口getTargetID="+message.getTargetID());
    	Log.d("iMessage", "旧接口getTargetName="+message.getTargetName());
    	Log.d("iMessage", "新接口getTargetInfo="+message.getTargetInfo());
    	
    	Log.d("iMessage", "新接口getFromUser="+userInfo);
    	Log.d("iMessage", "旧接口getFromID="+message.getFromID());
    	Log.d("iMessage", "旧接口getFromName="+message.getFromName());
    	Log.d("iMessage", "旧接口getFromType="+message.getFromType());
    ...
    public void onEventMainThread(UserDeletedEvent event){
    	...
    	UserInfo message = event.getMyInfo();
    	Log.d("JPush", message+"用户被服务端删除");
	...
	public void onEvent(MessageEvent event) {
    	...
    	Log.e("converYK", "会话列表:"+JMessageClient.getConversationList());
    	for (Conversation c:JMessageClient.getConversationList())
    	{
    		msg = c.getLatestMessage();
    		Log.e("converYK", "未读消息："+c.getUnReadMsgCnt());
    	}
